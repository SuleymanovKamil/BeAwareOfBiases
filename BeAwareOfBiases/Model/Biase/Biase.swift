...
struct Biase: Identifiable, Hashable {
    ...
    static var biases: [Biase] = [
        ...
        Biase(title: "Эффект присоединения к большинству", subtitle: "Популярность определённых убеждений увеличивается по мере того, как их принимает всё больше людей.", description: "Анна верит, что спиннер полезен  её детям. Джон тоже.", image: "lifepreserver", type: [.social, .belief, .politic], url: "https://ru.wikipedia.org/wiki/%D0%AD%D1%84%D1%84%D0%B5%D0%BA%D1%82_%D0%BF%D1%80%D0%B8%D1%81%D0%BE%D0%B5%D0%B4%D0%B8%D0%BD%D0%B5%D0%BD%D0%B8%D1%8F_%D0%BA_%D0%B1%D0%BE%D0%BB%D1%8C%D1%88%D0%B8%D0%BD%D1%81%D1%82%D0%B2%D1%83"),
        Biase(title: "Групповое мышление", subtitle: "Стремление к конформизму и гармонии внутри группы приводят к некорректному или нерациональному принятию решений.", description: "Анна хочет мороженное. Джон хочет купить футболку. Вы предлагаете им приобрести футболки с изображением мороженного.", image: "person.2.wave.2", type: [.social, .belief, .politic], url: "https://ru.wikipedia.org/wiki/%D0%93%D1%80%D1%83%D0%BF%D0%BF%D0%BE%D0%B2%D0%BE%D0%B5_%D0%BC%D1%8B%D1%88%D0%BB%D0%B5%D0%BD%D0%B8%D0%B5"),
